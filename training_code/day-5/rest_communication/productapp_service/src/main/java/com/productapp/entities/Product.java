...
public class Product {
	...
	//if it product then return true else retrun false
	
	public boolean isITProduct() {
		return this.getProductType().equals("IT");
		
	}
	
	
	public Product(Integer id, String name, BigDecimal price, String productType) {
		super();
		this.id = id;
		this.name = name;
		this.price = price;
